...
//Use the string %userinfo% to signify where you would like your name placed (from data/userinfo.title_name)
export const homepageinfo: homepageinfoType = {
  hero_intro: "Hello",
  intro_text: "My name is %userinfo%, welcome to my portfolio.",
  carousel_text: "I'm a ",
